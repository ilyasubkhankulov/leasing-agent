...
Revision ID: 728455e2e369
Revises: 
Create Date: 2025-06-23 23:13:00.226945
...
def downgrade() -> None:
    ...
    -- Drop the pgcrypto extension if no other objects depend on it
    -- Note: This will fail if other objects in the database depend on pgcrypto
    -- In most cases, you should manually verify dependencies before dropping
